...
public sealed class ConfigTests
{
    ...
    [Fact]
    public void SanitizeContent_Valid_ReturnsValue()
    {
        Assert.Equal("hello", Sanitizer.SanitizeContent("hello"));
    }

    [Fact]
    public void SanitizeContent_Empty_Throws()
    {
        Assert.Throws<ArgumentException>(() => Sanitizer.SanitizeContent(""));
    }

    [Fact]
    public void SanitizeContent_TooLong_Throws()
    {
    ...
    [Fact]
    public void SkipDirs_ContainsNodeModules()
    {
        Assert.Contains("node_modules", Constants.SkipDirs);
    }

    [Fact]
    public void ReadableExtensions_ContainsCSharp()
    {
